namespace Nabbit.Services.LogOn {
	public static class B2CConstants {
...
#else
		public static string ClientID = "5a4321ff-ef86-45c3-90ee-934af14923da";
#endif
		...
		public static string[] Scopes = { "https://nabbit.onmicrosoft.com/api-msal/user_impersonation" };
